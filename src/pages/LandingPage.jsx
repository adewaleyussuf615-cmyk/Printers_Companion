...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-[#FAFBFC] font-sans overflow-x-hidden relative">
      ...
      {/* Full responsive landing page canvas */}
      <div className="w-full min-h-screen bg-white relative overflow-hidden flex flex-col justify-between z-10">
        {/* Content Wrapper */}
